...
export class NewFamilyMemberComponent implements OnInit {
  ...
  onUpdate(familyMember: FamilyMember): void {
    ...
    this.familyMembersService.createFamilyMember(familyMember).subscribe((newFamilyMember) => this.router.navigate([FamilyMembersPaths.familyMember.path, newFamilyMember.id]))
  }
